...
const Top = ({ data }) => (
  ...
  >
    <Container1024 className={styles.topContentContainer}>
      <div className={styles.topLeftContainer} data-sal="slide-up">
...
const StrongPoints = ({ data }) => (
  <div className={styles.strongPointContainer}>
    <Container1024 className={styles.section}>
      <div
        className={`${styles.left47} ${styles.figContainer}`}
      ...
      <div>
        <Padding y={271} />
        <span className={styles.title} data-sal="slide-up">
          <Trans i18nKey="about:strongPoint1Title" />
        </span>
        <div className={styles.desc} data-sal="slide-up">
    ...
    <Container1024 className={styles.section}>
      ...
      <div
        className={`${styles.left46} ${styles.figContainer}`}
        data-sal="slide-up-image"
      >
        <Img
...
const FeatureRow = ({ id, title, columns }) => (
  <div id={id} className={styles.featureRow}>
    <div className={styles.featureRowTitle} data-sal="slide-up">
      {title}
    </div>
...
const OtherFeatures = ({ data, t }) => (
  ...
  >
    <Container1024 className={styles.featureContentContainer}>
      <div className={styles.featureTitle} data-sal="slide-up">
        {t("about:otherFeaturesTitle")}
      </div>

      <Padding y={40} />
      <div className={styles.featureDesc} data-sal="slide-up">
