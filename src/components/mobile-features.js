  ...
  return (
    ...
    >
      <Container320>
        <div
          data-sal="slide-up"
          className={`${styles.px20} ${styles.featureTemplateTitle}`}
        >
          {props.title}
        </div>
        ...
        <div
          className={`${styles.px20} ${styles.featureTemplateDesc}`}
          data-sal="slide-up"
        >
          {props.desc}
        </div>
        ...
        <div className={styles.px20}>
          {props.demoData.slice(0, 2).map((data, index) => (
            <div data-sal="slide-up" data-sal-delay={150 * index} key={index}>
              <DemoTemplate
                index={index}
                key={index}
                icon={data.icon}
