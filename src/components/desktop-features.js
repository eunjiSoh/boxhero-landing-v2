      ...
      <Container1024>
        <div className={styles.featureTemplateDescFigContainer}>
          <div className={styles.featureTemplateTitleDescContainer}>
            <div className={styles.featureTemplateTitle} data-sal="slide-up">
              {props.title}
            </div>

            <Padding y={35} />

            <div data-sal="slide-up" className={styles.featureTemplateDesc}>
              {props.desc}
            </div>
        ...
        <div className={styles.halfContainer}>
          {props.demoData.slice(0, 2).map((data, index) => (
            <div data-sal="slide-left" data-sal-delay={150 * index} key={index}>
              <DemoTemplate
                key={index}
