...
const Top = ({ data, t }) => (
  ...
  >
    <Container320 className={styles.topContentContainer}>
      ...
      <Padding y={30} />
      <div className={styles.topImageContainer} data-sal="slide-up-image">
  ...
  <div className={isDarkBg ? styles.darkBg : ""}>
    <Container320 className={styles.keyFeatureContentContainer}>
      <div className={styles.px20}>
        ...
        <Padding y={10} />
        <div data-sal="slide-up" className={styles.keyFeatureTitle}>
          {title}
        </div>
        <Padding y={20} />
        <div data-sal="slide-up" className={styles.keyFeatureDescription}>
          {desc}
        </div>
        <Padding y={20} />
        <div data-sal="slide-up" className={styles.keyFeatureSubTitle}>
          {subTitle}
        </div>
        <div className={styles.keyFeatureSubDesc} data-sal="slide-up">
          {subDesc}
        </div>
        <Padding y={20} />
...
const TeamPlay = ({ data, t }) => (
  ...
  >
    ...
    <Padding y={20} />
    <Container320 className={styles.teamPlayDesc} data-sal="slide-up">
