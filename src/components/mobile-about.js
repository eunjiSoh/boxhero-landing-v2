...
const Top = ({ data }) => (
  ...
  >
    <Container320 className={styles.topContentContainer}>
      <Padding y={94} />
      <div className={styles.topTitleContainer} data-sal="slide-up">
...
const StrongPoints = ({ data }) => (
  <Container320>
    <div className={styles.section}>
      <div className={styles.title} data-sal="slide-up">
      ...
      <div className={styles.logoContainer} data-sal="slide-up-image">
    ...
    <div className={styles.section}>
      ...
      <div className={styles.logoContainer} data-sal="slide-up-imag3e">
  ...
  <div id={id} className={styles.featureRow}>
    ...
    <div className={styles.featureContainer}>
      {columns.map((column, index) => (
        <div data-sal="slide-up" key={index + title}>
          <FeatureCard
            key={index}
            img={column.img}
            title={column.title}
